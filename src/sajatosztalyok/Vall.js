...
export default class Vall extends React.Component {
  ...
  componentDidMount(){
    return fetch('http://localhost:8080/gyakorlatok_vall')
    ...
    return(
      <View style={{}}>
        <FlatList
          ...
          <Image  source={{uri: 'http://localhost:8080/'+item.gyakorlat_kep}} style={{width:500,height:400,marginLeft:"auto",marginRight:"auto"}} />  

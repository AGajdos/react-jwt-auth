...
export default class Vadli extends React.Component {
  ...
  componentDidMount(){
    return fetch('http://localhost:8080/gyakorlatok_vadli')
    ...
    return(
      <View style={{}}>
        <FlatList
          ...
          <View style={{padding:40,marginBottom:10,  border: "solid blue", borderRadius:60,backgroundColor: "#B9F3EA",}}>
          <Text style={{color:"brown",fontSize:40,textAlign:"center",marginTop:15,marginBottom:5,fontWeight:"bold" }}   >{item.gyakorlat_nev} </Text>
          <Image  source={{uri: 'http://localhost:8080/'+item.gyakorlat_kep}} style={{width:500,height:300,marginLeft:"auto",marginRight:"auto"}} />  
